...
<!-- SIMPLIFIED BADDEO TEMPLATE -->
	...
	<!-- SPACES LEFT -->
	<?php if ($num_attendees >= $reg_limit) { ?>
		<p id="available_spaces-<?php echo $event_id ?>" class="<?php espresso_template_css_class('available_spaces','available-spaces'); ?>">
			<span class="<?php espresso_template_css_class('section_title','section-title'); ?>"><?php _e('Spaces left:', 'event_espresso') ?> </span>
			<?php echo apply_filters('filter_hook_espresso_available_spaces_text', $event_id) ?>
		</p>
		<?php if ($overflow_event_id != '0' && $allow_overflow == 'Y') { ?>
			<p id="register_link-<?php echo $overflow_event_id ?>" class="<?php espresso_template_css_class('register_link-footer','register-link-footer'); ?>">
				<a class="<?php espresso_template_css_class('a_register_link','a_register_link ui-button ui-button-big ui-priority-primary ui-state-default ui-state-hover ui-state-focus ui-corner-all'); ?>" id="a_register_link-<?php echo $overflow_event_id ?>" href="<?php echo espresso_reg_url($overflow_event_id); ?>" title="<?php echo stripslashes_deep($event_name) ?>">
	...
	<?php } 
			...
			<p id="available_spaces-<?php echo $event_id ?>" class="<?php espresso_template_css_class('spaces_available','spaces-available'); ?>">
				<span class="<?php espresso_template_css_class('section_title','section-title'); ?>"><?php _e('Spaces left:', 'event_espresso') ?></span>
				<?php echo apply_filters('filter_hook_espresso_available_spaces_text', $event_id) ?>
			</p>
	<?php 		}
...
<!-- ORIGINAL EE TEMPLATE -->
	...
	<div id="event_data-<?php echo $event_id ?>" class="<?php espresso_template_css_class('event_data_display','event_data '.$css_class.' '.$category_identifier.' event-data-display event-list-display event-display-boxes ui-widget'); ?>">
		<h3 id="event_title-<?php echo $event_id ?>" class="<?php espresso_template_css_class('event_title','event_title ui-widget-header ui-corner-top'); ?>">
			<a title="<?php echo stripslashes_deep($event_name) ?>" class="<?php espresso_template_css_class('a_event_title','a_event_title'); ?>" id="a_event_title-<?php echo $event_id ?>" href="<?php echo $registration_url; ?>">
		...
		<div class="<?php espresso_template_css_class('event_meta','event-meta clearfix'); ?>">
			...
			?>
			 <p id="event_date-<?php echo $event_id ?>">
				<span class="<?php espresso_template_css_class('section_title','section-title'); ?>">
